          ...
          <div className="mx-auto grid max-w-[1200px] gap-14 lg:grid-cols-[1fr_0.8fr] lg:items-center">
            <div>
              ...
              <div className="mt-7 space-y-5 text-sm leading-7 text-[#211914]/60">
                <p>
                  At Gopal Tours & Travels, we believe good travel planning
                  starts with listening. Every journey has different priorities,
                  and the details matter.
                </p>

                <p>
                  Whether you are looking for a carefully planned tour, a
                  comfortable hotel, a luxury property or help arranging flights,
                  our role is to bring the pieces together and make travel feel
                  simpler.
                </p>
            ...
            <div className="grid gap-px bg-white/10 sm:grid-cols-3">
              <div className="bg-[#211914] p-8 sm:p-10">
                ...
                <p className="mt-5 text-sm leading-6 text-white/50">
                  Discover journeys across India's mountains, coastlines, cities,
                  heritage destinations and cultural heartlands.
                </p>
              </div>
              ...
              <div className="bg-[#211914] p-8 sm:p-10">
                ...
                <p className="mt-5 text-sm leading-6 text-white/50">
                  Travel plans shaped around your destination, dates, preferences
            ...
            <div className="grid gap-10 border-t border-[#211914]/10 pt-10 md:grid-cols-[1fr_auto] md:items-end">
              <div>
                ...
                <p className="mt-5 max-w-xl text-sm leading-7 text-[#211914]/55">
                  Whether you already know where you want to go or simply want to
                  start exploring, speak directly with the Gopal Tours & Travels
                  team.
                </p>
              </div>
              ...
              <div className="flex flex-col items-start gap-4 sm:flex-row md:flex-col md:items-stretch">
                <Link
                  ...
                  className="group inline-flex items-center justify-between gap-10 bg-[#d59a55] px-7 py-4 text-[9px] font-bold uppercase tracking-[0.2em] text-[#211914] shadow-[0_5px_0_#8c5e2f] transition-all duration-200 hover:-translate-y-1 hover:bg-[#e2ae6e]"
                >
