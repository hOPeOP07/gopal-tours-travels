        ...
        <div className="mx-auto max-w-[1440px]">
          <div className="flex flex-col justify-between gap-8 md:flex-row md:items-end">
            ...
            <p className="max-w-md text-sm leading-6 text-white/55">
              Handpicked journeys across India&apos;s mountains, palaces, coastlines
                ...
                <div className="relative aspect-[16/10] overflow-hidden bg-[#30251e]">
                  ...
                  <div className="absolute inset-x-0 bottom-0 p-7 sm:p-9">
                    ...
                    <div className="mt-5 flex items-center justify-between">
                      ...
                      <span className="flex h-10 w-10 items-center justify-center border border-white/30 bg-white/5 text-sm backdrop-blur-md transition duration-300 group-hover:border-[#d8a15e] group-hover:bg-[#d8a15e] group-hover:text-[#211914]">
                        ↗
                      </span>
                    </div>
                  </div>
